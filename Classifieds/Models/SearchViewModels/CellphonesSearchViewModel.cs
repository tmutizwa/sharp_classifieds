...
namespace Classifieds.Models.SearchViewModels
{
    public class CellphonesSearchViewModel  : AListingSearchModel 
    {
        ...
        public List<SelectListItem> oses = new List<SelectListItem> { new SelectListItem { Text = "Choose", Value = "" }, new SelectListItem { Text = "Android", Value = "android" }, new SelectListItem { Text = "IOs / Iphone", Value = "ios" }, new SelectListItem { Text = "Windows", Value = "windows" }, new SelectListItem { Text = "Blackberry", Value = "blackberry" }, new SelectListItem { Text = "Other", Value = "other" } };
        ...
        public List<SelectListItem> brands = new List<SelectListItem> { new SelectListItem { Text = "Choose", Value = "" }, new SelectListItem { Text = "Iphone", Value = "iphone" }, new SelectListItem { Text = "Samsung", Value = "samsung" }, new SelectListItem { Text = "HTC", Value = "htc" }, new SelectListItem { Text = "Sony", Value = "sony" }, new SelectListItem { Text = "Nokia", Value = "nokia" }, new SelectListItem { Text = "LG", Value = "lg" }, new SelectListItem { Text = "Other", Value = "other" } };
